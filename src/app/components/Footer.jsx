    ...
    return (
        <div className={'footer-main bg-black/90 p-4 mt-4'}>
            <div className="social-logo py-2 flex flex-col sm:flex-row gap-4 items-center justify-between sm:px-16">
                <div className="logo">
                    <Image src='/logo.png' alt={'logo-app'} width={150} height={100}/>
                </div>
                <div className="social flex items-center gap-4 transition duration-1000">
                    <Link href={'https://twitter.com/Niketmishravns'} className={'icon text-xl sm:text-2xl bg-blue-500 hover:bg-white text-white hover:text-blue-500 rounded-full'}>
                        <AiOutlineTwitter className={'m-2'}/>
                    </Link>
                    <Link href={'https://www.instagram.com/mishrank_mkp25675/'} className={'icon text-xl sm:text-2xl bg-red-500 hover:bg-white text-white hover:text-red-500 rounded-full'}>
                        <AiFillInstagram className={'m-2'}/>
                    </Link>

                    <Link href={'https://www.linkedin.com/in/niket-kumar-mishra-37ab5a215/'} className={'icon text-xl sm:text-2xl bg-blue-700 hover:bg-white text-white hover:text-blue-700 rounded-full'}>
            ...
            <div className="copyright text-white py-4 flex flex-col gap-3 sm:flex-row justify-between items-center sm:px-16">
                <p>Copyright © 2023 CineVerse. All rights reserved</p>
